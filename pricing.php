...
<section class="page-header">
    <div class="container">
        <h1 class="fade-in-up">Our Pricing Plans</h1>
        <p class="fade-in-up delay-1">Affordable, transparent pricing with no hidden fees. Choose the plan that fits your business.</p>
    </div>
</section>
...
<section class="section-padding pricing-section">
    <div class="container">
        <!-- Trust badges -->
        <div class="pricing-badges text-center fade-in-up" style="margin-bottom: 3rem;">
            ...
            <span><i class="fas fa-star" style="color:#F59E0B;"></i> 5.0 Rating</span>
        </div>
...
<!-- FAQ Section -->
<section class="section-padding bg-dark-subtle">
    <div class="container">
        ...
        <div class="faq-grid fade-in-up">
            <div class="faq-item">
                <h4><i class="fas fa-question-circle" style="color:var(--primary-color); margin-right:8px;"></i>How long does it take to build a website?</h4>
                <p>Depending on the plan, delivery ranges from 3–14 working days after receiving all required content from the client.</p>
            </div>
            <div class="faq-item">
                <h4><i class="fas fa-question-circle" style="color:var(--primary-color); margin-right:8px;"></i>Do you provide hosting?</h4>
                <p>We guide you to the best affordable hosting options. Hosting fees are separate from our development charges.</p>
            </div>
            <div class="faq-item">
                <h4><i class="fas fa-question-circle" style="color:var(--primary-color); margin-right:8px;"></i>Can I upgrade my plan later?</h4>
                <p>Yes! You can always upgrade to a higher plan by paying the difference. We make scaling seamless.</p>
            </div>
            <div class="faq-item">
                <h4><i class="fas fa-question-circle" style="color:var(--primary-color); margin-right:8px;"></i>What if I need a refund?</h4>
                <p>We offer a 100% money-back guarantee if work hasn't been started. Once we begin, we ensure your complete satisfaction with revisions.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="section-padding bg-gradient">
    <div class="container text-center fade-in-up">
        <h2 style="color: white; font-size: 2.5rem; margin-bottom: 20px;">Ready to Get Started?</h2>
        <p style="color: rgba(255,255,255,0.9); max-width: 600px; margin: 0 auto 30px;">Message us on WhatsApp and we'll get your project started within 24 hours.</p>
        <a href="https://wa.me/917001044700" target="_blank" class="btn btn-secondary" style="padding: 15px 40px; font-size: 1.1rem;">
            <i class="fab fa-whatsapp" style="margin-right:8px; color:#25D366;"></i> WhatsApp Us Now
        </a>
    </div>
</section>
